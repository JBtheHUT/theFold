        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (titleTimer < 0)//this timer is to avoid the lightning fast checks that makes pausing very flickery
            {
                ...
                if (kb.IsKeyDown(Keys.Enter))
                {
                    ...
                    #region
                    /*
                    if (gameState == "title"&& titleTimer < 0) { 
                        gameState = "tutorial_A";
                        titleTimer = 50;
                        
                    }
                    else
                        if (gameState == "tutorial_A" && titleTimer < 0) { 
                        gameState = "tutorial_B";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_B" && titleTimer < 0) { 
                        gameState = "tutorial_C";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_C" && titleTimer < 0) { 
                        gameState = "tutorial_D";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_D" && titleTimer < 0) { 
                        gameState = "tutorial_E";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_E" && titleTimer < 0) { 
                        gameState = "tutorial_F";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_F" && titleTimer < 0) { 
                        gameState = "tutorial_G";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_G" && titleTimer < 0) { 
                        gameState = "tutorial_H";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_H" && titleTimer < 0) { 
                        gameState = "tutorial_I";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "tutorial_I" && titleTimer < 0) { 
                        gameState = "game";
                        titleTimer = 50;
                    }
                    else
                        if (gameState == "game" && titleTimer < 0) { 
                        gameState = "title";
                        titleTimer = 50;
                    }
                    */
            ...
            if (gameState == "game")
            {
                ...
                KeyboardState kb = Keyboard.GetState();
                if ((shepPlayer.Position.Z > 222) && (shepPlayer.Position.Z < 500) && (shepPlayer.Position.X > 3802) && (shepPlayer.Position.X < 4024))
                     gameState = "endtitle";
